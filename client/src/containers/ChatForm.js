...
const ChatForm = () => {
    ...
    return (
        <Fragment>
            <IsLoggedIn />
            <div className="flex justify-center mx-[10rem] mt-2">
                <div className="w-full">
                    <div className="flex justify-center">
                        <ContactList formChat={handleFormChat} />
                        {
                            !chat ?
                                <div className="w-full mx-1 bg-gray-100 rounded-b-md border border-black/25">
                                    <div className="rounded-md">
                                        ...
                                        <div className="flex w-full h-screen max-h-[88vh] border-t-2 justify-center items-center">
                                ...
                                <div className="w-full max-w-full mx-1">
                                    <div className="rounded-md">
                                        ...
                                        <div className="overflow-y-scroll heigh-calc py-4 bg-gray-100 border">
                                            {
                                                selected.map(item => {
                                                    return (
                                                        <ChatBody
                                        ...
                                        <form onSubmit={submitChat}>
                                            <div className="bg-white w-full border-2 rounded-b-md">
                                                <div className="p-2.5">
